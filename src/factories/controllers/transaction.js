import { PostgresCreateTransactionRepository } from "../../repositories/transaction/create-transaction.js";
...
export const makeCreateTransactionController = () => {
    ...
    const postgresGetUserByIdRepository = PostgresGetUserByIdRepository();
